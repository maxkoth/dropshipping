...
const SAUNAZEN_CONFIG = {
  checkoutUrl: (typeof window !== 'undefined' && window.PAYMENT_LINKS && window.PAYMENT_LINKS['saunazen-signature-blanket']) || 'https://checkout.stripe.com/pay/YOUR_SAUNAZEN_PAYMENT_LINK',
  currency: 'USD',
